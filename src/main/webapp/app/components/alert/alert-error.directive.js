(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('kudoflashApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-kudoflashApp-error');
                var entityKey = httpResponse.headers('X-kudoflashApp-params');
                if (errorHeader) {
